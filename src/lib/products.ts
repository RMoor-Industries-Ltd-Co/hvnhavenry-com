...
export const PRODUCTS: Record<ProductId, Product> = {
  ...
  emberLine: {
    ...
    tagline: "One line. One moment. Pure intention.",
    description:
      "The essential HVN experience. The Ember Line is a slow-burn line for atmosphere — low smoke, pure diffusion. Each line carries the signature HVN blend: clean, even, consistent. Ritual in its purest form.",
    details: [
      "Signature HVN blend — no fillers",
      "Slow burn design — crafted for time, not volume",
      "Low smoke, clean atmosphere",
      "Natural core, matte coating",
      "12 lines per box",
    ],
    price: "$38",
    shopifyUrl: "https://hvnhavenry.com/products/ember-line",
    accentColor: "#0d0a07",
