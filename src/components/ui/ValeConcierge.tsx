...
// Small bottom-right confirmation toasts ("noted your selection" / "see you through").
// The full concierge — the on-screen Vale plus his dialogue box — now lives in
// ConciergeReveal (bottom-left); this file only owns these transient moments.
